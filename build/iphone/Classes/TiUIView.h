...
/**
 Base class for all DLRmediathek views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the DLRmediathek view hierarchy (such as wrapped iOS UIViews) was touched.
