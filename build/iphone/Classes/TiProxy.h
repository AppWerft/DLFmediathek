...
//Rare exceptions to indicate a bug in the _dlrmediathek code (Eg, function that a subclass should have implemented)
...
/**
 The base class for DLRmediathek proxies.
 */
