...
@interface DLRmediathekObject : KrollCoverageObject {
#else
@interface DLRmediathekObject : KrollObject {
#endif
@private
...
extern NSString * DLRmediathek$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	DLRmediathekObject *_dlrmediathek;
    KrollObject* console;
	BOOL shutdown;
