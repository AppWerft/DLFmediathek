...
// in simulator we redefine to format for DLRmediathek Developer console
...
{\
	NSString * exceptionName = [@"org.dlrmediathek." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.dlrmediathek";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIDLRmediathekNativeItemNone = -1, 
	UIDLRmediathekNativeItemSpinner = -2,
	UIDLRmediathekNativeItemProgressBar = -3,
	
	UIDLRmediathekNativeItemSlider = -4,
	UIDLRmediathekNativeItemSwitch = -5,
	UIDLRmediathekNativeItemMultiButton = -6,
	UIDLRmediathekNativeItemSegmented = -7,
	
	UIDLRmediathekNativeItemTextView = -8,
	UIDLRmediathekNativeItemTextField = -9,
	UIDLRmediathekNativeItemSearchBar = -10,
	
	UIDLRmediathekNativeItemPicker = -11,
	UIDLRmediathekNativeItemDatePicker = -12,
	
	UIDLRmediathekNativeItemInfoLight = -13,
	UIDLRmediathekNativeItemInfoDark = -14,
	
	UIDLRmediathekNativeItemDisclosure = -15,
	
	UIDLRmediathekNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all DLRmediathek instances of
